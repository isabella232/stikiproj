...
?>
<style type="text/css">
#cmdjadwalbaru, #cmdbatal, #cmdjadwalhapus{
    margin-top: 20px;
    margin-left: 10px;
    width: 150px;
    height: 40px;
...
<td><button id="cmdjadwalhapus">Hapus</button> <button id="cmdbatal">Batal</button></td>
</table>
...
$(document).ready(function(){
    ...
    $('#cmdjadwalhapus').click(function(){
        var url = "moduls/jadwalkuliah.php";
        var dt = "idjadwal=<?PHP echo $idjadwal;?>";
        $.ajax({
    		type	: "POST",
    		url		: "moduls/jadwalkuliahsimpandatahps.php",
    		data	: dt,
    		success	: function(data){
    		  var url = "moduls/jadwalkuliah.php";
              $('.span9').load(url);
